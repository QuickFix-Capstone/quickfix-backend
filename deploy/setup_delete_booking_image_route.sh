...
aws lambda add-permission \
  ...
  --source-arn "arn:aws:execute-api:${AWS_REGION}:${AWS_ACCOUNT_ID}:${API_ID}/*/*/bookings/{booking_id}/images/{image_id}" \
...
echo "   Endpoint: https://${API_ID}.execute-api.${AWS_REGION}.amazonaws.com/bookings/{booking_id}/images/{image_id}"
