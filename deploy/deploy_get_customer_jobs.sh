...
# Deploy get_customer_jobs Lambda function
# This script packages and deploys the get_customer_jobs function to AWS Lambda
...
echo "👉 Creating zip..."
cd $BUILD_DIR
zip -r get_customer_jobs.zip . -q
cd ..

echo "👉 Updating Lambda code: $FUNCTION_NAME ..."
aws lambda update-function-code \
    --function-name $FUNCTION_NAME \
    --zip-file fileb://$BUILD_DIR/get_customer_jobs.zip \
    --region us-east-2
