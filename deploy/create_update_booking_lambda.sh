#!/usr/bin/env bash
# Create the update_booking Lambda function in AWS

set -e

FUNC_NAME="update_booking"
...
aws lambda create-function \
  ...
  --description "Update booking details - supports reschedule, cancel, and address updates"
