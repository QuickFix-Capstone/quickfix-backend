...
LAMBDA_NAME="upload_job_image"
ROUTE_KEY="POST /jobs/{job_id}/images/upload-url"
...
aws lambda add-permission \
  ...
  --source-arn "arn:aws:execute-api:${AWS_REGION}:${AWS_ACCOUNT_ID}:${API_ID}/*/*/jobs/{job_id}/images/upload-url" \
...
echo "   Endpoint: https://${API_ID}.execute-api.${AWS_REGION}.amazonaws.com/jobs/{job_id}/images/upload-url"
