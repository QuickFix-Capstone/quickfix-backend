...
LAMBDA_NAME="get_job_images"
ROUTE_KEY="GET /jobs/{job_id}/images"
...
aws lambda add-permission \
  ...
  --source-arn "arn:aws:execute-api:${AWS_REGION}:${AWS_ACCOUNT_ID}:${API_ID}/*/*/jobs/{job_id}/images" \
...
echo "   Endpoint: https://${API_ID}.execute-api.${AWS_REGION}.amazonaws.com/jobs/{job_id}/images"
