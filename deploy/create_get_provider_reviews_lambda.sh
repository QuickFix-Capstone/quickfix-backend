#!/usr/bin/env bash
# Create the get_provider_reviews Lambda function in AWS
...
aws lambda create-function \
  ...
  --description "Get all reviews for a service provider with pagination and sorting"
...
./deploy_get_provider_reviews.sh
