#!/usr/bin/env bash
# Create the update_review Lambda function in AWS
...
aws lambda create-function \
  ...
  --description "Update existing review (rating and/or comment) with ownership verification"
