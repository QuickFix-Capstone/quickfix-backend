...
LAMBDA_NAME="accept_price_change"
ROUTE_KEY="POST /jobs/{jobId}/price-change-requests/{requestId}/accept"
...
aws lambda add-permission \
  ...
  --source-arn "arn:aws:execute-api:${AWS_REGION}:${AWS_ACCOUNT_ID}:${API_ID}/*/*/jobs/{jobId}/price-change-requests/{requestId}/accept" \
...
echo "   Endpoint: https://${API_ID}.execute-api.${AWS_REGION}.amazonaws.com/jobs/{jobId}/price-change-requests/{requestId}/accept"
