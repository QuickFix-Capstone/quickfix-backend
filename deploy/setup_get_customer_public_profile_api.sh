...
FUNC_NAME="get_customer_public_profile"
AWS_REGION="us-east-2"
AWS_ACCOUNT_ID="008971679867"
API_ID="kfvf20j7j9"
AUTHORIZER_ID="z8zn33"
ROUTE_KEY="GET /provider/customers/{customer_id}/profile"
...
aws lambda add-permission \
  ...
  --source-arn "arn:aws:execute-api:${AWS_REGION}:${AWS_ACCOUNT_ID}:${API_ID}/*/*/provider/customers/*/profile" \
...
echo "GET https://${API_ID}.execute-api.${AWS_REGION}.amazonaws.com/prod/provider/customers/{customer_id}/profile"
