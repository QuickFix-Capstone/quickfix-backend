#!/usr/bin/env bash
# Create the get_review_by_id Lambda function in AWS
...
aws lambda create-function \
  ...
  --description "Get review details by ID (accessible by customers and providers)"
