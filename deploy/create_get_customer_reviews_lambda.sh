#!/usr/bin/env bash
# Create the get_customer_reviews Lambda function in AWS
...
aws lambda create-function \
  ...
  --description "Get all reviews for a customer with pagination and sorting"
...
./deploy_get_customer_reviews.sh
