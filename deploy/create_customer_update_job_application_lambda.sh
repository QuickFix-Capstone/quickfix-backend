...
FUNC_NAME="customer_update_job_application"
...
aws lambda create-function \
  ...
  --description "Customer edits pending applications for owned jobs"

rm -rf "${TEMP_DIR}"

echo "Lambda created. Deploying application code..."
bash deploy/deploy_customer_update_job_application.sh
