#!/usr/bin/env bash
# Create the create_customer_provider_review Lambda function in AWS
...
aws lambda create-function \
  ...
  --description "Create a customer review for a provider (customer_provider_reviews table)"
...
./deploy_create_customer_provider_review.sh
