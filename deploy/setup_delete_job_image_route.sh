...
LAMBDA_NAME="delete_job_image"
ROUTE_KEY="DELETE /jobs/{job_id}/images/{image_id}"
...
aws lambda add-permission \
  ...
  --source-arn "arn:aws:execute-api:${AWS_REGION}:${AWS_ACCOUNT_ID}:${API_ID}/*/*/jobs/{job_id}/images/{image_id}" \
...
echo "   Endpoint: https://${API_ID}.execute-api.${AWS_REGION}.amazonaws.com/jobs/{job_id}/images/{image_id}"
