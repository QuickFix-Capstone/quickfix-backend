...
LAMBDA_NAME="get_booking_details"
ROUTE_KEY="GET /customer/bookings/{booking_id}"
...
aws lambda add-permission \
  ...
  --source-arn "arn:aws:execute-api:${AWS_REGION}:${AWS_ACCOUNT_ID}:${API_ID}/*/*/customer/bookings/{booking_id}" \
...
echo "   Endpoint: https://${API_ID}.execute-api.${AWS_REGION}.amazonaws.com/prod/customer/bookings/{booking_id}"
