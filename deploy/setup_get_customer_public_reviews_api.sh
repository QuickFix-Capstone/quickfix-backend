...
FUNC_NAME="get_customer_public_reviews"
AWS_REGION="us-east-2"
AWS_ACCOUNT_ID="008971679867"
API_ID="kfvf20j7j9"
AUTHORIZER_ID="z8zn33"
ROUTE_KEY="GET /provider/customers/{customer_id}/reviews"
...
aws lambda add-permission \
  ...
  --source-arn "arn:aws:execute-api:${AWS_REGION}:${AWS_ACCOUNT_ID}:${API_ID}/*/*/provider/customers/*/reviews" \
  --region "${AWS_REGION}" > /dev/null || echo "⚠️  Permission may already exist"
...
echo "GET https://${API_ID}.execute-api.${AWS_REGION}.amazonaws.com/prod/provider/customers/{customer_id}/reviews"
