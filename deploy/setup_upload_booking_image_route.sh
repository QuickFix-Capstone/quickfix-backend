...
LAMBDA_NAME="upload_booking_image"
ROUTE_KEY="POST /bookings/{booking_id}/images/upload-url"
...
aws lambda add-permission \
  ...
  --source-arn "arn:aws:execute-api:${AWS_REGION}:${AWS_ACCOUNT_ID}:${API_ID}/*/*/bookings/{booking_id}/images/upload-url" \
...
echo "   Endpoint: https://${API_ID}.execute-api.${AWS_REGION}.amazonaws.com/bookings/{booking_id}/images/upload-url"
