...
def handler(event, context):
    """
    Lambda entrypoint for getting all reviews ABOUT the logged-in customer.
    
    This returns reviews where the customer is the REVIEWEE (not reviewer).
    Use case: "Show me all the reviews providers have written about me"
    ...
    Example URLs:
        ...
        GET /customer/reviews-about-me?sort=highest_rating&limit=10&offset=0
    ...
    try:
        with conn.cursor() as cur:
            ...
            # 6) Get total count of reviews ABOUT this customer
            count_sql = """
            ...
            # 7) Get reviews with provider information (reviewer)
            ...
            for row in reviews_data:
                reviews.append({
                    ...
                    "service_title": row['service_title'] or "Service",
                    "rating": row['rating'],
                    "comment": row['comment'],
        ...
        print(f"Error in get_customer_reviews_about_me: {e}")
        import traceback
        traceback.print_exc()
        return _response(
            500,
...
if __name__ == "__main__":
    print("=" * 70)
    print("Testing GET /customer/reviews-about-me")
    print("=" * 70)
    
    # Test 1: Get reviews about customer 1
    print("\n📋 Test 1: Get reviews about Customer 1")
    print("-" * 70)
    test_event_1 = {
        "customer_id": 1,
    ...
    # Test 2: Test with different sort
