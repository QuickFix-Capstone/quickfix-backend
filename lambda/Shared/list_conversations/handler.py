        ...
        for conv in conversations:
            formatted_conv = {
                ...
                "lastMessage": {
                    ...
                    "timestamp": int(conv.get('lastMessageAt', 0))  # Convert Decimal to int
                },
                "unreadCount": int(conv.get('unreadCount', 0)),  # Convert Decimal to int
                "createdAt": int(conv.get('createdAt', 0))  # Convert Decimal to int
            }
